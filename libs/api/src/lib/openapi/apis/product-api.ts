...
import { ProductListResponseFromJSON, ProductResponseFromJSON } from '../models/index';
...
export class ProductApi extends runtime.BaseAPI {
   ...
   * Get all products
   */
  async getAllProductsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProductListResponse>> {
