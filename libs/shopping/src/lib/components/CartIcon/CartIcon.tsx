...
export const CartIcon = () => {
  ...
  return (
    <div className="ml-4 flow-root lg:ml-6">
      <a onClick={handleShowCart} className="group -m-2 flex items-center p-2 cursor-pointer">
        <svg
        ...
        <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800">{getItemCount()}</span>
